...
class AntibodiesControllerTest < ActionController::TestCase
  ...
  test "should create antibody" do
    assert_difference('Antibody.count') do
      post :create, antibody: { description: @antibody.description, product_ID: @antibody.product_ID, target: @antibody.target, vendor: @antibody.vendor }
    end
  ...
  test "should update antibody" do
    put :update, id: @antibody, antibody: { description: @antibody.description, product_ID: @antibody.product_ID, target: @antibody.target, vendor: @antibody.vendor }
    assert_redirected_to antibody_path(assigns(:antibody))
  end
