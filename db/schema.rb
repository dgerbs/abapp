...
ActiveRecord::Schema.define(:version => 20130525170432) do
  ...
  add_index "antibodies", ["user_id"], :name => "index_antibodies_on_user_id"
  ...
  add_index "protocols", ["antibody_id"], :name => "index_protocols_on_antibody_id"
